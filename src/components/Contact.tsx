...
export function Contact() {
  ...
  return (
    <section id="contact" className="py-16 md:py-24 bg-white parallax">
      <div className="container mx-auto px-4 md:px-6">
        <h2 className="section-title reveal reveal-delay-100">Get In Touch</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mt-10">
          <div className="md:col-span-5 space-y-6 reveal reveal-delay-200">
            ...
            <div className="space-y-4 mt-8">
              <div className="flex items-center space-x-3 hover:-translate-y-1 transition-transform duration-300">
                <Mail className="text-navy animate-pulse" size={20} />
                <span className="text-gray-700">parijatkundu123@gmail.com</span>
              </div>
              
              <div className="flex items-center space-x-3 hover:-translate-y-1 transition-transform duration-300">
                <MapPin className="text-navy animate-pulse" size={20} />
                <span className="text-gray-700">Ranaghat-I, West Bengal, India</span>
              </div>
              
              <div className="flex items-center space-x-3 hover:-translate-y-1 transition-transform duration-300">
                <Linkedin className="text-navy animate-pulse" size={20} />
              ...
              <div className="flex items-center space-x-3 hover:-translate-y-1 transition-transform duration-300">
                <Github className="text-navy animate-pulse" size={20} />
          ...
          <div className="md:col-span-7 reveal reveal-delay-300">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <RippleButton type="submit" className="btn-animated bg-navy hover:bg-navy-dark text-white w-full sm:w-auto transform transition-transform hover:scale-105 active:scale-95" disabled={isSubmitting}>
                {isSubmitting ? (
                  <div className="flex items-center gap-2">
                    <LoadingSpinner size="sm" className="border-white border-l-transparent" />
                    <span>Sending...</span>
                  </div>
                ) : "Send Message"}
              </RippleButton>
